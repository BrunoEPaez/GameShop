...
export default function App() {
  ...
  const addToCart = (product: any) => {
    setCart((prevCart: any) => {
      ...
      if (cantidadEnCarrito >= product.stock) {
        alert(`¡Límite alcanzado! Solo tenemos ${product.stock} unidades de este producto.`);
        return prevCart;
      }
  ...
  return (
    <div className="app-container">
      <Navbar 
        ...
        isAdmin={isAdmin} // Esto ahora es dinámico
        user={user}       // PASA ESTA PROP
        onLogout={handleLogout} // PASA ESTA PROP
      />
  ...
  <div style={{
    ...
    AVISO: EL SECTOR DE ADQUISICIONES SE ENCUENTRA EN MANTENIMIENTO HASTA NUEVO AVISO
  </div>
)}
  ...
  {/* ADMIN: IMPORTANTE pasar el estado y la función para cambiarlo */}
  <Route 
    path="/admin" 
  ...
  <span className="wa-tooltip">¡Consultanos por WhatsApp!</span>
  <a 
